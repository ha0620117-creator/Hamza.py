...
os.system('xdg-openhttps://youtube.com/@hamzaahmed-rf6xy?si=R6Ik8ZvSewx-9wsG
os.system('xdg-open https://wa.me/qr/H3E4TY2WW6AAI1?mode=ems_copy_t')
...
# Your WhatsApp link
channel_link = "https://wa.me/qr/H3E4TY2WW6AAI1
# Valid keys (cleaned - no trailing space)
approved_keys = [
    "HAMZA 03255471480=2025 UPDATE"
]
...
def first_step():
    ...
    print("Please open the admin https://wa.me/qr/H3E4TY2WW6AAI1.\n")
...
os.system('clear')
print(' \x1b[38;5;46m HAMZA 🫶🏻 🔥 SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【HAMZA👑 】𓆪 \x07')


    # HAMZA Clover Logo - Green - Version 2.5
def ____banner____():
